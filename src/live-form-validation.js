// wrap it in setTimeout so that loading order of LiveFormOptions
// does not matter
setTimeout(() => {
  /**
  ...
  (function (global, factoryLiveValidation, factoryNetteForm) {
    ...
    function (window) {
      ...
      LiveForm.processServerErrors = function (el) {
        ...
        var errorEls = parentEl.getElementsByClassName(
          this.options.messageErrorClass
        );
    ...
    */
    ...
    function (window) {
       ...
       */
      Nette.validateControl = function (
        elem,
        rules,
        onlyCheck,
        value,
        ...
        for (var id = 0, len = rules.length; id < len; id++) {
          ...
          var success = Nette.validateRule(
            curElem,
            rule.op,
            rule.arg,
            elem === curElem ? value : undefined
          );
      ...
      Nette.validateForm = function (sender, onlyCheck) {
        ...
        if (
          ...
          var scopeArr = JSON.parse(
            form["nette-submittedBy"].getAttribute(
              "data-nette-validation-scope"
            ) || "[]"
          );
          if (scopeArr.length) {
      ...
      Nette.isDisabled = function (elem) {
        if (elem.type === "radio") {
          for (
            var i = 0, elements = elem.form.elements;
            i < elements.length;
            i++
          ) {
